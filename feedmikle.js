(function(d, w) {
	...
	d.write(
		...
		+ '\x3ciframe id="' + i + '" name="' + i + '" height="150" width="150" style="position:relative" class="fw-iframe" scrolling="no" frameborder="0" data-fw-params="' + fwparam + '"' + preloader_text + '">\x3c/iframe>'
